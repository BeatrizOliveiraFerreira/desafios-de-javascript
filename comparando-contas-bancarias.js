...
// TODO: Crie o objeto JSON do Cliente 1 e suas propriedades (nome, conta e saldo):
const cliente1 = {
    nome: gets(),
    conta: gets(),
    saldo: parseFloat(gets()), // Use parseFloat para garantir que o saldo seja um número decimal.
  };
